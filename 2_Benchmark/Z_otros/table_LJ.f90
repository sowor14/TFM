...
! Versió amb la derivada finita.
      ...
      program table_lj
       implicit none
       real*4 ::r_max,r_min,dr,r,u_lj,f_lj,a,ua,du_lj
       integer :: i_lim,i,j
       common/param/a,ua
...
!-----------------------------------------------------------------------
      function du_lj(r,dr,i)
       implicit none
       real*4 :: epsilj,sigmlj,r,a,ua,epsimix,sigmix,dr,u_ljb,u_ljf
       real*4 :: du_lj,rb,rf
       integer :: i
       common/param/a,ua
